...
export async function campaignRoutes(fastify: FastifyInstance) {
  ...
  // List campaigns
  fastify.get('/', { preHandler: [requirePermission('campaigns:read')] }, async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  // Get campaign by ID
  fastify.get<{ Params: { id: string } }>('/:id', { preHandler: [requirePermission('campaigns:read')] }, async (request, reply) => {
  ...
  // Create campaign
  fastify.post('/', { preHandler: [requirePermission('campaigns:manage'), enforcePlanLimit('maxCampaigns')] }, async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  // Start campaign
  fastify.post<{ Params: { id: string } }>('/:id/start', { preHandler: [requirePermission('campaigns:manage')] }, async (request, reply) => {
    const { id } = request.params
  ...
  // Pause campaign
  fastify.post<{ Params: { id: string } }>('/:id/pause', { preHandler: [requirePermission('campaigns:manage')] }, async (request, reply) => {
    const { id } = request.params
  ...
  // Cancel campaign
  fastify.post<{ Params: { id: string } }>('/:id/cancel', { preHandler: [requirePermission('campaigns:manage')] }, async (request, reply) => {
    const { id } = request.params
  ...
  // Get campaign report
  fastify.get<{ Params: { id: string } }>('/:id/report', { preHandler: [requirePermission('campaigns:read')] }, async (request, reply) => {
    const { id } = request.params
  ...
  // Delete campaign
  fastify.delete<{ Params: { id: string } }>('/:id', { preHandler: [requirePermission('campaigns:manage')] }, async (request, reply) => {
    const { id } = request.params
    ...
    await prisma.campaign.deleteMany({ where: { id, companyId: request.user.companyId } })
