...
export function Login() {
  ...
  // Fetch public config to determine if signup is enabled
  useEffect(() => {
    api.get('/installation/config')
      .then(res => setSignupEnabled(res.data.signupEnabled === true))
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-green-100 dark:from-gray-900 dark:to-gray-800 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl">IMPA CRM</CardTitle>
          <CardDescription>
        ...
        <CardContent>
          ...
          <Tabs defaultValue="login">
            ...
            /* Signup disabled - show only login form, no tabs */
            <form onSubmit={loginForm.handleSubmit(handleLogin)} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="login-email-only">Email</Label>
                <Input
                  id="login-email-only"
                  type="email"
                  placeholder="seu@email.com"
              ...
              <div className="space-y-2">
                <Label htmlFor="login-password-only">Senha</Label>
                <Input
