    ...
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-semibold text-foreground flex items-center gap-2.5">
          <div className="p-2 rounded-lg bg-primary/8"><Code className="h-5 w-5 text-primary" /></div>
          Documentação da API
        </h2>
        <p className="text-muted-foreground text-sm mt-1">
          Integre o WhatsApp ao seu sistema. Selecione uma instância para ver os endpoints disponíveis.
        </p>
      </div>
...
# ============================================
# IMPA CRM - Script de Alerta Zabbix
# ============================================
