...
export function Header() {
  ...
  const handleUpdate = () => {
    ...
    // Create EventSource for SSE (cookie sent automatically via withCredentials)
  ...
  return (
    <>
      <header className="z-30 flex h-14 items-center justify-between border-b border-border/40 bg-background/80 backdrop-blur-lg px-6">
        <div />
